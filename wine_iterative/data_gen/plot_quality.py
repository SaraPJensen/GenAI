...
def plot_complete_col_shape():
    ...
    fig.update_layout(
        title=dict(text=f'Column shapes score,<br>w.r.t. complete real wine quality dataset', font=dict(size=28)),
...
def plot_complete_col_trends():
    ...
    fig.update_layout(
        title=dict(text=f'Column pair trends score,<br>w.r.t. complete real wine quality dataset', font=dict(size=28)),
        xaxis=dict(title=dict(text = '% of real data to train synthesizer',
                            font = dict(size=20)), 
                    tickfont=dict(size=20)),
...
def plot_test_col_shape():
    ...
    fig.update_layout(
        title=dict(text=f'Column shapes score,<br>w.r.t. real test wine quality dataset', font=dict(size=28)),
        xaxis=dict(title=dict(text = '% of real data to train synthesizer',
                            font = dict(size=20)), 
                    tickfont=dict(size=20)),
        yaxis=dict(title=dict(text = 'Column shapes score',
...
def plot_test_col_trends():
    ...
    fig.update_layout(
        title=dict(text=f'Column pair trends score,<br>w.r.t. real test wine quality dataset', font=dict(size=28)),
        xaxis=dict(title=dict(text = '% of real data to train synthesizer',
                            font = dict(size=20)), 
                    tickfont=dict(size=20)),
        yaxis=dict(title=dict(text = 'Column trends score',
