...
def plot_all_gan_loss(modeltype, gan_part):
    ...
    fig.update_layout(
            title=dict(text=f'{gan_part} loss progress for {model_name}, wine data', font=dict(size=28)),
...
def plot_all_tvae_loss():
    ...
    fig.update_layout(
            title=dict(text=f'Loss progress for {model_name}, wine data', font=dict(size=28)),
            xaxis=dict(title=dict(text = 'Epoch',
                                font = dict(size=20)), 
                        tickfont=dict(size=20)),
            yaxis=dict(title=dict(text = 'Loss',
