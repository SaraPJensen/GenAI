...
def plot_final_combined_real_test_acc():
    ...
    fig.update_layout(
        title=dict(text=f'Final prediction accuracy on test-set,<br>real wine quality data, trained on combined dataset', font=dict(size=28)),
        xaxis=dict(title=dict(text = '% of real data to train synthesizer',
                            font = dict(size=20)), 
                    tickfont=dict(size=20)),
        yaxis=dict(title=dict(text = 'Accuracy',
...
def plot_final_combined_real_complete_acc():
    ...
    fig.update_layout(
        title=dict(text=f'Final prediction accuracy on complete set,<br>real wine quality data, trained on combined dataset', font=dict(size=28)),
        xaxis=dict(title=dict(text = '% of real data to train synthesizer',
                            font = dict(size=20)), 
                    tickfont=dict(size=20)),
        yaxis=dict(title=dict(text = 'Accuracy',
...
def plot_final_combined_test_acc():
    ...
    fig.update_layout(
        title=dict(text=f'Final prediction accuracy on test-set,<br>wine quality data, trained on combined dataset', font=dict(size=28)),
        xaxis=dict(title=dict(text = '% of real data to train synthesizer',
                            font = dict(size=20)), 
                    tickfont=dict(size=20)),
        yaxis=dict(title=dict(text = 'Accuracy',
...
def plot_final_combined_training_acc():
    ...
    fig.update_layout(
        title=dict(text=f'Final prediction accuracy on training-set,<br>wine quality data, trained on combined dataset', font=dict(size=28)),
        xaxis=dict(title=dict(text = '% of real data to train synthesizer',
                            font = dict(size=20)), 
                    tickfont=dict(size=20)),
        yaxis=dict(title=dict(text = 'Accuracy',
