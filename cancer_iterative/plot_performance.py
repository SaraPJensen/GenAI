...
def plot_final_real_test_acc():
    ...
    fig.update_layout(
        title=dict(text=f'Final prediction accuracy on test-set,<br>real cancer data', font=dict(size=28)),
    ...
    with open('training_progress/real_test_final_acc.png', "wb") as f:
        f.write(img_bytes)
...
def plot_final_real_complete_acc():
    ...
    fig.update_layout(
        title=dict(text=f'Final prediction accuracy on complete set,<br>real cancer data', font=dict(size=28)),
        xaxis=dict(title=dict(text = '% of real data to train synthesizer',
                            font = dict(size=20)), 
                    tickfont=dict(size=20)),
        yaxis=dict(title=dict(text = 'Accuracy',
    ...
    img_bytes = fig.to_image(format="png", scale=3)
    with open('training_progress/real_complete_final_acc.png', "wb") as f:
        f.write(img_bytes)
...
def plot_final_test_acc():
    ...
    fig.update_layout(
        title=dict(text=f'Final prediction accuracy on test-set,<br>cancer data', font=dict(size=28)),
        xaxis=dict(title=dict(text = '% of real data to train synthesizer',
                            font = dict(size=20)), 
                    tickfont=dict(size=20)),
        yaxis=dict(title=dict(text = 'Accuracy',
...
def plot_final_training_acc():
    ...
    fig.update_layout(
        title=dict(text=f'Final prediction accuracy on training-set,<br>cancer data', font=dict(size=28)),
        xaxis=dict(title=dict(text = '% of real data to train synthesizer',
                            font = dict(size=20)), 
                    tickfont=dict(size=20)),
        yaxis=dict(title=dict(text = 'Accuracy',
...
def plot_final_combined_real_test_acc():
    modelnames = ['real', 'gaussian', 'ctgan', 'tvae', 'copula']
    dataset_names = ['Real', 'GaussianCopula', 'CTGAN', 'TVAE', 'CopulaGAN']
    ...
    for (model, c, data_name) in zip(modelnames, colours, dataset_names):
        ...
        for p in range(10, 100, 10):
            if model == 'real':
                ...
                filepath = f'training_progress/{p}_train/{model}_combined_progress.csv'
            df = pd.read_csv(filepath)
    ...
    fig.update_layout(
        title=dict(text=f'Final prediction accuracy on test-set,<br>real cancer data, trained on combined dataset', font=dict(size=28)),
        xaxis=dict(title=dict(text = '% of real data to train synthesizer',
                            font = dict(size=20)), 
                    tickfont=dict(size=20)),
        yaxis=dict(title=dict(text = 'Accuracy',
...
def plot_final_combined_real_complete_acc():
    ...
    fig.update_layout(
        title=dict(text=f'Final prediction accuracy on complete set,<br>real cancer data, trained on combined dataset', font=dict(size=28)),
        xaxis=dict(title=dict(text = '% of real data to train synthesizer',
                            font = dict(size=20)), 
                    tickfont=dict(size=20)),
        yaxis=dict(title=dict(text = 'Accuracy',
...
def plot_final_combined_test_acc():
    modelnames = ['real', 'gaussian', 'ctgan', 'tvae', 'copula']
    dataset_names = ['Real', 'GaussianCopula', 'CTGAN', 'TVAE', 'CopulaGAN']
    ...
    fig.update_layout(
        title=dict(text=f'Final prediction accuracy on test-set,<br>cancer data, trained on combined dataset', font=dict(size=28)),
        xaxis=dict(title=dict(text = '% of real data to train synthesizer',
                            font = dict(size=20)), 
                    tickfont=dict(size=20)),
        yaxis=dict(title=dict(text = 'Accuracy',
...
def plot_final_combined_training_acc():
    ...
    fig.update_layout(
        title=dict(text=f'Final prediction accuracy on training-set,<br>cancer data, trained on combined dataset', font=dict(size=28)),
        xaxis=dict(title=dict(text = '% of real data to train synthesizer',
                            font = dict(size=20)), 
                    tickfont=dict(size=20)),
        yaxis=dict(title=dict(text = 'Accuracy',
...
plot_final_combined_test_acc()
plot_final_combined_training_acc()
plot_final_combined_real_complete_acc()